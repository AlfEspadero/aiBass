...
const osMutexAttr_t windowMutex_attributes = { .name = "windowMutex" };
osMutexId_t uartTxMutexHandle;
const osMutexAttr_t uartTxMutex_attributes = { .name = "uartTxMutex" };*/
...
int __io_putchar(int ch) {
	...
	return (tx_status == HAL_OK) ? ch : EOF;
}
/* USER CODE END 4 */
